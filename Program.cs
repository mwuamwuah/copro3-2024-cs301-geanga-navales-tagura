...
namespace MDVAD100
{
    ...
    class Character : CharacterBase, ICharacterActions
    {
        ...
        public void InputFeature(string featureName, int minChoice, int maxChoice)
        {
            ...
            {
                Console.WriteLine("\n=========================================================\n");
                Console.WriteLine($"Choose {featureName}:");
                ...
                Console.Write($"Enter the number corresponding to your choice ({minChoice}-{maxChoice}) : ");
            ...
            // Handling boolean specfically without changing the cases
            switch (featureName)
            {
                case "if you want to Wear Jewelry?":
                    if (choice == 1)
        ...
        public (int strength, int agility, int intelligence, int vitality, int luck, int dexterity, int endurance) PointAllocation()
        {
            ...
            while (totalPoints > 0)
            {
                ...
                Console.Write("Enter points to allocate (1-5) : ");
                ...
                {
                    Console.WriteLine($"\nInvalid input. Enter a number between 1 and 5, and no more than your remaining points ({totalPoints}).");
                    Console.WriteLine("\n=========================================================\n");
                    continue;
                }
        ...
        public void Display()
        {
            Console.WriteLine("\nTagumpay ang pagkakagawa sa character!!");
            Console.WriteLine("+-------------------+---------------------+-----------------------+");
            ...
            try
            {
                while (GameisRunning)
                {
                    ...
                    if (choice == "1")
                    {
                        ...
                        while (ToGoOrNah)
                        {
                            Console.WriteLine("'Y' Go back to Main Menu Or Press 'S' to Start Game (Y/S)");
                    ...
                    #region -- CAMPAIGN MODE, CREDITS, EXIT --
                    else if (choice == "3")
                    {
